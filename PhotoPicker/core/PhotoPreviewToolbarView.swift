...
class PhotoPreviewToolbarView: UIView {
    ...
    private func configView(){
        ...
        backArrow.addTarget(self, action: "eventBackArrow", forControlEvents: .TouchUpInside)
        ...
        checkbox!.addTarget(self, action: "eventCheckbox:", forControlEvents: .TouchUpInside)
